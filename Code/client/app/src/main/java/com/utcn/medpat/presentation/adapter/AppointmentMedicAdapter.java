...
public class AppointmentMedicAdapter extends ArrayAdapter<Appointment> {

    public AppointmentMedicAdapter(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public AppointmentMedicAdapter(Context context, int resource, List<Appointment> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (a != null) {
            ...
            if (tt1 != null) {
                tt1.setText(String.valueOf(a.getMedic().getName()));
            }
